...
const Services: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Personalized mentorship and hands-on guidance to help you build your own software or IoT projects from scratch.",
      features: [
        "Guide for building Softwre and IoT projects",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            business needs with cutting-edge technology and innovative
            solutions.
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                >
                  <div className="text-6xl font-bold text-blue-600/30 dark:text-blue-400/30 mb-4">
                    {phase.step}
                  </div>
            ...
            <motion.button
              ...
              onClick={() =>
                (window.location.href =
                  "https://linked.in/in/rajesharulprakash/")
              }
            >
              Get In Touch
            </motion.button>
